...
namespace VenditPublicSdk.Entities
{
    ...
    public class ProductStockDetail
    {
        ...
        {
            return $"{FrameNumber} {LockNumber} {KeyNumber} {DataTagNumber} {SerialNumber} {ImeiNumber} {LicensePlateNumber} {LicensePlateMeldcode} {MotorNumber} {Remark} {PassportNumber} {DisplayNumber} {BatteryNumber} {KeyNumber2} {BikeImeiNumber} {VinNumber} {VelopassNumber}".Trim();
        }
    }
}
