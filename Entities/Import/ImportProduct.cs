...
{
    [Serializable]
    public class ImportProduct // previously inherited from BaseProduct, however all value types need to be nullable :-(
    {
        ...
        public DateTime? ResaleStart { get; set; }
        public DateTime? ResaleEnd { get; set; }
        ...
        public Results<ImportProductActionPrice> ActionPrices { get; set; }
